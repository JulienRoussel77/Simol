...
namespace simol
{
  ...
  class Dynamics
  {
    ...
    //-- external forces --
      ...
      shared_ptr<CVBasis> cvBasis() {return galerkin_?make_shared<CVBasis>(dynamic_cast<TensorBasis*>(galerkin_->tensorBasis()), make_shared<DVec>(galerkin_->CVcoeffsVec())):nullptr;}
