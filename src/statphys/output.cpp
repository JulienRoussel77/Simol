...
namespace simol{
    ...
    decorrelationNumberOfIterations_(0)
  {
    ...
    outObservables_ << "# time kineticEnergy potentialEnergy energy temperature" << std::endl;
    outParticles_ << "# time index position momentum kineticEnergy potentialEnergy energy force" << std::endl;
    outReplica_ << "# time dt externalForce position momentum <responseForces> <responseForces2>" << std::endl;
    outVelocities_ << "# time i=0 i=N/4 i=N/2 i=3N/4 i=N-1" << std::endl;
    outVelocitiesCV_ << "# time b <b> <b2> D <D> >D2> observable <observable> >observable2> LPhi <LPhi> <LPhi2>" << std::endl;
    outForcesCV_ << "# time b <b> <b2> D <D> >D2> observable <observable> >observable2> LPhi <LPhi> <LPhi2>" << std::endl;
    outLengthsCV_ << "# time b <b> <b2> D <D> >D2> observable <observable> >observable2> LPhi <LPhi> <LPhi2>" << std::endl;
    outMidFlowCV_ << "# time b <b> <b2> D <D> >D2> observable <observable> >observable2> LPhi <LPhi> <LPhi2>" << std::endl;
		outSumFlowCV_ << "# time b <b> <b2> D <D> >D2> observable <observable> >observable2> LPhi <LPhi> <LPhi2>" << std::endl;
  ...
  {
      std::cout << "nbOfParticles : " << numberOfParticles_ << std::endl;
    ...
    std::cout << "decorrelationNumberOfIterations : " << decorrelationNumberOfIterations_ << std::endl;
  ...
  void Output::display(std::vector<Particle> const& configuration, size_t indexOfIteration)
  {
  ...
  void Output::finalDisplay(std::vector<Particle> const& configuration, Vector<double> const& externalForce)
  {
      std::cout<< "replica : " << finalTime()
		<< " " << timeStep()
		<< " " << externalForce(0)
  ...
  void Output::finalDisplayAutocorrelations()
  {
 	...
 	void Output::appendTemperatureProfile(double value, size_t iOfIteration, size_t iOfParticle)
	{
		...
		/*std::cout << value << " " << iOfParticle << std::endl;
          std::cout << temperatureProfile_.lastValue(iOfParticle) << std::endl;
          std::cout << temperatureProfile_.mean(iOfParticle) << std::endl << std::endl;*/
	}
