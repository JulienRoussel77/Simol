...
namespace simol
{
  ...
  public:
    ...
    virtual void update(double observable, VectorXd& generatorOnBasisFunction, std::vector<Particle> const& configuration, size_t indexOfIteration);

    // FUNCTION CARACTERIZATION

    virtual double basisFunction(std::vector<Particle> const& configuration, size_t iOfFunction = 0) const = 0;


    virtual double laplacienQ(std::vector<Particle> const& configuration, size_t indexOfParticle = 0, size_t iOfFunction = 0) const = 0;
    virtual Vector<double> gradientQ(std::vector<Particle> const& configuration, size_t indexOfParticle = 0, size_t iOfFunction = 0) const = 0;
    virtual double laplacienP(std::vector<Particle> const& configuration, size_t indexOfParticle = 0, size_t iOfFunction = 0) const = 0;
    virtual Vector<double> gradientP(std::vector<Particle> const& configuration, size_t indexOfParticle = 0, size_t iOfFunction = 0) const = 0;
  ...
  public:
    ...
    virtual size_t nbOfFunctionPairs() const;
    bool isNone() const;
    double basisFunction(std::vector<Particle> const& configuration, size_t iOfFunction = 0) const;
    virtual double laplacienQ(std::vector<Particle> const& configuration, size_t indexOfParticle = 0, size_t iOfFunction = 0) const;
    virtual Vector<double> gradientQ(std::vector<Particle> const& configuration, size_t indexOfParticle = 0, size_t iOfFunction = 0) const;
    virtual double laplacienP(std::vector<Particle> const& configuration, size_t indexOfParticle = 0, size_t iOfFunction = 0) const;
    virtual Vector<double> gradientP(std::vector<Particle> const& configuration, size_t indexOfParticle = 0, size_t iOfFunction = 0) const;
    void update(double observable, VectorXd& generatorOnBasisFunction, std::vector<Particle> const& configuration, size_t indexOfIteration);
    virtual void postTreat(std::ofstream& out, double timeStep);
  };
