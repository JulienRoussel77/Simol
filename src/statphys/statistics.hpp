...
namespace simol
{
  ...
  {
      std::cout << "AutocorrelationStats<T>::append(T newValue, size_t iOfIteration) not implemented !" << std::endl;
  ...
  {
      std::cout << "AutocorrelationStats<T>::integratedAutocorrelationUnbiased() not implemented !" << std::endl;
    exit(1);
    return 0;
  }
