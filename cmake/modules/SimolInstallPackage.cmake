...
foreach(LIBRARY_NAME IN LISTS LIBRARY_NAMES)
    ...
    ExternalProject_Add(${LIBRARY_LOWERNAME}
                        ...
                        CMAKE_ARGS -D CMAKE_C_COMPILER=${SIMOL_C_COMPILER} -D CMAKE_CXX_COMPILER=${SIMOL_CXX_COMPILER} -D CMAKE_Fortran_COMPILER=${SIMOL_Fortran_COMPILER} ${${LIBRARY_UPPERNAME}_ARGS}
